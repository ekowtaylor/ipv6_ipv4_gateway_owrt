...
sys.path.insert(0, '/opt/ipv4-ipv6-gateway')

from ipv4_ipv6_gateway import (
    DeviceMapping, NetworkInterface, ARPMonitor,
    DHCPv6Manager, DeviceStore, GatewayService
)
...
class TestGatewayService(unittest.TestCase):
    ...
    def test_service_initialization(self, mock_iface, mock_dhcp, mock_arp):
        ...
        # Initialize (would normally require real network access)
